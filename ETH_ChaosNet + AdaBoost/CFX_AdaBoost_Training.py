...
Code Description: A python code to tune the hyperparameters of ChaosNet + AdaBoost on the Credit Card dataset.
...
#validation
FOLD_NO = 5
INITIAL_NEURAL_ACTIVITY = [0.410]
DISCRIMINATION_THRESHOLD = [0.099]
EPSILON = [0.32]
